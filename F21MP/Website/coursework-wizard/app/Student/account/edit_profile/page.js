...
export default function EditProfile() {
    ...
    const fetchProfile = async () => {
      try {
        ...
        if (data.length > 0) {
          ...
          setBio(student.description || "");
          setSocialLinks({
            linkedin: student.linkedin || "",
            instagram: student.instagram || "",
            github: student.github || ""
          });
          setExistingDp(student.picture || "/Black/account.png"); // Use existing picture if available
        }
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        const response = await fetch('/api/updateStudentProfile', {
            method: 'POST',
            headers: {
        ...
        if (response.ok) {
            ...
            router.push('/Student/account/profile'); // Redirect to profile page
        } else {
        ...
        <div className={styles.withoutFooter}>
          ...
          <form className={styles.box} onSubmit={handleSubmit} encType="multipart/form-data">
            ...
            <div className={styles.thirdColumn}>
              ...
              <Link href="/Student/account/profile">
